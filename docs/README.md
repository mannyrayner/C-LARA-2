...
- **Image generation pipeline (planned)**: [roadmap/image-generation-pipeline.md](roadmap/image-generation-pipeline.md) – describes the proposed three-stage image workflow (style, recurring elements, page images), review/approval checkpoints, project-scoped artifact persistence, and the main design questions to resolve before implementation.
