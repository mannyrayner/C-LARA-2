...
- **As of:** 2026-08-14
- **Assessed commit:** `6596e285392820d31af26bd326df54b89fc86655`
...
The Digital Minds Sprint remains the critical immediate task, while the unresolved EuroCALL authorship dispute now requires a parallel publication-preservation response: after two weeks without substantive committee information, separately identified updated versions of both papers should be prepared promptly for ResearchGate with the original author lists. The updates can report material new evidence—the consented public Voice Mode session summaries are queryable through the Assistant, and passing a C-LARA-2 text URL to ChatGPT before Voice Mode now provides a substantially cleaner preliminary multimodal integration. The most time-sensitive user path remains community-recorded audio and judging autosave before Sophie’s 24 August visit; legacy migration remains the first post-Sprint completion target.
...
Sarah-approved session summaries are now public and queryable through the C-LARA-2 Assistant, while ChatGPT can use a C-LARA-2 text URL before Voice Mode to access text, navigate pages, and view images without the earlier screenshot-upload workflow.

- **Observed:** 2026-08-14
- **Confidence:** high
- **Evidence:** [`docs/publications/eurocall_2026_voice_mode/session_summaries/README.md`](../publications/eurocall_2026_voice_mode/session_summaries/README.md), [`docs/publications/eurocall_2026_voice_mode/latex/voice_mode_german_case_study.tex`](../publications/eurocall_2026_voice_mode/latex/voice_mode_german_case_study.tex), [`docs/issues/issues/ISSUE-0043.json`](../issues/issues/ISSUE-0043.json)
...
EuroCALL process risk is now acute after two weeks without substantive information, while the papers are becoming technically stale; prompt, separately versioned ResearchGate updates preserve the original authorship position and convert two recent platform developments into citable research evidence.

- **Goals:** `GOAL-3`, `GOAL-5`
- **Grounding observations:** `OBS-0007`, `OBS-0010`, `OBS-0011`, `OBS-0012`, `OBS-0018`
- **Urgency / risk / progress:** critical / high / researchgate_insurance_update_ready_to_prepare_external_status_unresolved
- **Confidence:** high
...
- **UNC-0001:** EuroCALL acceptance, rejection, presentation, and travel consequences remain unresolved after two weeks without substantive committee information; public updated versions must be clearly distinguished from the immutable submitted versions.
...
- **ACT-0001:** Keep ISSUE-0042 as the immediate critical task and use the Sprint to settle the smallest useful experimental protocol.
  - **Assessments:** `ASM-0003`
- **ACT-0002:** Prepare and post clearly dated, separately versioned ResearchGate updates of both EuroCALL papers with their original author lists, add the session-summary/Assistant evidence and URL-based Voice Mode integration where relevant, preserve the submitted manuscripts unchanged, and continue to record any EuroCALL response.
  - **Assessments:** `ASM-0004`
...
- **Basis:** Manny Rayner reported two weeks without further EuroCALL information and proposed prompt ResearchGate insurance versions preserving the original authors and incorporating two recent developments.
- **Comments:** Revision 7 records the increased publication-process risk and recommends separately versioned updates without altering the historical submission artifacts.
- **Change summary:** Recorded the prolonged EuroCALL silence, the decision direction toward ResearchGate insurance versions, and two material developments that now make the papers stale.
