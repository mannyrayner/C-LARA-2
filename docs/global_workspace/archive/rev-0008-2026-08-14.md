...
- **As of:** 2026-08-14
- **Assessed commit:** `ac210f4306f9e62922226fae924d576e5a8c9a34`
...
The Digital Minds Sprint remains the critical immediate task, while EuroCALL publication preservation now has a precise bounded response: the submitted papers remain unchanged, no new C-LARA-2 paper is needed because the existing ResearchGate progress report subsumes it, and a separately titled Voice Mode report now has a first repository draft. That draft preserves the original authors, explains its provenance and unresolved EuroCALL status, reframes the study around adding free conversation to C-LARA-2, and reports both the URL-based Voice Mode workflow and Assistant access to consented session summaries. The most time-sensitive user path remains community-recorded audio and judging autosave before Sophie’s 24 August visit; legacy migration remains the first post-Sprint completion target.
...
EuroCALL process risk remains acute, but the publication-insurance scope is now efficient and non-duplicative: retain both submissions unchanged, rely on the existing progress report for C-LARA-2 coverage, and publish the new extended Voice Mode report after author review.

- **Goals:** `GOAL-3`, `GOAL-5`
- **Grounding observations:** `OBS-0007`, `OBS-0010`, `OBS-0011`, `OBS-0012`, `OBS-0018`
- **Urgency / risk / progress:** critical / high / first_voice_mode_report_draft_ready_for_author_review_external_status_unresolved
- **Confidence:** high
...
- **ACT-0001:** Keep ISSUE-0042 as the immediate critical task and use the Sprint to settle the smallest useful experimental protocol.
  - **Assessments:** `ASM-0003`
- **ACT-0002:** Review and revise the first draft of “Combining C-LARA-2 and ChatGPT Voice Mode: Initial experiments,” then post it as a separately titled ResearchGate report with the unchanged author list and provenance note; do not create a redundant C-LARA-2 paper update, and continue recording any EuroCALL response.
  - **Assessments:** `ASM-0004`
...
- **Basis:** Manny Rayner corrected the publication strategy and requested a first version of a new Voice Mode report rather than updates to both EuroCALL papers.
- **Comments:** Revision 8 narrows the insurance plan to a separately titled Voice Mode report, records the completed first draft, and preserves both EuroCALL submissions unchanged.
- **Change summary:** Corrected the ResearchGate strategy to avoid a redundant C-LARA-2 update and recorded completion of the first extended Voice Mode report draft.
