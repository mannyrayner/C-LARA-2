# C-LARA-2 issue overview (refreshed 2026-07-03T06:00:00Z)

## Recent progress

- Refined **ISSUE-0040** MWE validation UX: MWE IDs are now checked only within their local segment, mismatch messages name the differing component(s), and failed saves scroll to just after the submitted segment so the inline error is nearby.
