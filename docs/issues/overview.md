...
- **ISSUE-0034** now needs focused production diagnostics: the Assistant worker can answer many repository questions, but queries about the Assistant tab/self-understanding path consistently fail with a `failed rtm_newaddr` sandbox-layer error.
