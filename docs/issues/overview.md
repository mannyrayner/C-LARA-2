...
7. **[ISSUE-0004](issues/ISSUE-0004.json) (P2)** — Introduce AI-based review gates for phase outputs with extensible evaluator architecture.
8. **[ISSUE-0007](issues/ISSUE-0007.json) (P2)** — Use LLM prompt-construction indirection for page-image generation prompts.
9. **[ISSUE-0001](issues/ISSUE-0001.json) (P2)** — Support hosted compiled legacy content registration in C-LARA-2.

## Priority distribution

- **P1:** [ISSUE-0002](issues/ISSUE-0002.json), [ISSUE-0003](issues/ISSUE-0003.json), [ISSUE-0006](issues/ISSUE-0006.json), [ISSUE-0008](issues/ISSUE-0008.json), [ISSUE-0009](issues/ISSUE-0009.json)
