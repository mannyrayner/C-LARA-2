# C-LARA-2 issue overview (refreshed 2026-07-03T05:30:00Z)

## Recent progress

- Improved **ISSUE-0040** MWE-consistency error UX: failed segment saves now preserve the edited fields and show the error directly under the relevant segment save control.
