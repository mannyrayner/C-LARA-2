...
_Last updated: 2026-05-23T12:00:00Z_
...
1. **[ISSUE-0016](issues/ISSUE-0016.json) (P1, active, deadline 2026-06-01)** — Validate no-audio/skip-TTS fallback on Kok Kaper and define next-step community-recorded audio workflow.
...
6. **[ISSUE-0021](issues/ISSUE-0021.json) (P1, reported)** — Add GPT-Image-2 as a selectable image generation model.
7. **[ISSUE-0008](issues/ISSUE-0008.json) (P1, reported, deadline 2026-06-15)** — Produce technical report and publication outputs.
8. **[ISSUE-0019](issues/ISSUE-0019.json) (P3, reported)** — Fix favicon reliability on AWS deployment.
...
| [ISSUE-0016](issues/ISSUE-0016.json) | active | P1 | Improve audio handling for low-resource languages without usable TTS. |
...
| [ISSUE-0019](issues/ISSUE-0019.json) | reported | P3 | Ensure favicon reliably appears on AWS deployment. |
...
| [ISSUE-0021](issues/ISSUE-0021.json) | reported | P1 | Add GPT-Image-2 as selectable model for element and page image generation. |
