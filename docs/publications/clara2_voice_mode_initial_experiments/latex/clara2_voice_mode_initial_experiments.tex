...
A prominent recent commercial example is Jumpspeak, whose public product materials advertise AI-supported speaking practice and conversation-oriented language learning \citep{Jumpspeak2026}. Its commercial positioning exemplifies the substantial practical interest in this type of application. The public-facing material, however, does not by itself establish how unconstrained its conversations are, how reliably it handles extended learner-led topic changes, or how its pedagogical behaviour compares with the high-end general-purpose system examined here. These would be useful questions for a direct comparative study.
