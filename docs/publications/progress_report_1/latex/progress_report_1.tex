...
As previously stated, the C-LARA-2 project in general, and this report in particular, are the result of a close collaboration between a human being, myself, and an AI, ChatGPT C-LARA-Instance. In this afterword, my purpose is to address a question which I expect that at least some readers will raise: does the AI have a reasonable right to be credited as one of the authors of the report? I should state now that the following represents my own opinions, and that these opinions are not necessarily shared by the other human authors.
...
Manny Rayner, Adelaide, 23 July 2026
