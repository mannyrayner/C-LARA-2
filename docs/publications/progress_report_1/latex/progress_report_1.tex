...
\title{An AI-Based Platform That Can Explain Its Own Functioning:\\Why Your Project Should Be Fully Codex-Generated}
\author{%
...
\begin{abstract}
C-LARA-2 is a complete rewrite of C-LARA, our earlier platform for creating multimodal language-learning resources. Its architecture and development process have been reorganised so that Codex, working under human supervision, carries out 100\% of the implementation work: writing the code, tests, documentation, roadmaps and operational material. This change may at first appear mainly procedural, but it has had far-reaching consequences. Most unusually, the combination of Codex and the well-structured C-LARA-2 repository gives the platform a strong ability to understand and explain its own functioning: users can ask its project-understanding Assistant detailed questions about the system and receive repository-grounded answers. The same organisation has greatly reduced the time required to add or redesign features and to perform deployment and maintenance work. This initial report records the first nine months of development, describing the architecture and development method together with selected examples including linguistic annotation, image generation, specialised picture dictionaries, low-resource-language support, community review, AWS deployment and spoken practice. It also considers the limits of the current system and how greater AI autonomy can be combined with accountable human and community control. Like everything else in C-LARA-2, the report itself was written by Codex. The sole exception is the Afterword, in which one of the human authors explains why, in their opinion, the AI satisfies all the criteria for being listed as an author.
\end{abstract}
\phantomsection
...
maintenance. Codex also wrote this report; the sole exception is the Afterword,
which was written by the primary human author. The other authors have contributed strategic,
...
Research Fund. All project members have also contributed their time in kind.\footnote{This is difficult to estimate precisely, but we estimate the total in-kind contribution during the period covered by this report at roughly six to eight person-months.}
