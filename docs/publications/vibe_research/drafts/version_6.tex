...
This provides a concrete reason for expecting high-end software agents to be useful research agents as well. No entirely new architecture is required. The same system which can inspect a software repository can inspect research materials stored inside it.
...
Development of C-LARA-2 began in November 2025. The reimplementation has been organised around an unusual development model: Codex, under human supervision, performs all implementation work, including code, tests, technical documentation, roadmaps, prompts, and much operational material \citep{bediEtAl2026clara2}. Human collaborators determine project goals, identify user needs, evaluate results, impose pedagogical and ethical constraints, and decide whether proposed changes are acceptable.
...
The paper, research history, supporting material, and relevant C-LARA-2 context are already stored in the repository and available to the project-understanding Assistant. The Voice Mode paper itself gives an example of querying the Assistant about this research material \citep{wrightEtAl2026voice}.
...
The experimental code, prompts, and artefacts are already public \citep{raynerChatGPT2025grok}. We plan to move the complete research context into the same C-LARA-2 repository structure used for the preceding examples and expose it through the existing project-understanding interface.

Once this has been done, the three cases will provide publicly interrogable examples at markedly different scales: a large long-term software and research project, an exploratory longitudinal language-learning study, and a rapid empirical investigation prompted by a topical question.
