...
The experimental code, prompts, exact model configuration, outputs, and analysis scripts are already public and documented in the paper's reproducibility appendix \citep[Appendix~A]{raynerChatGPT2025grok}. We plan to move the complete research context into the same C-LARA-2 repository structure used for the preceding examples and expose it through the existing project-understanding interface.
