...
In the classic Australian film \emph{The Castle},  inexperienced lawyer Dennis Denuto is convinced that his clients have a valid constitutional case, but is unable to express the underlying principle in formal legal terms. His argument eventually collapses into the memorable phrase, ``It's the vibe.'' At first, the audience is invited to laugh: whatever legal reasoning may consist of, Denuto surely does not understand it.\footnote{Every Australian knows this scene. Non-Australians will easily find it on the Web, for example at \url{https://www.youtube.com/watch?v=nMuh33BMZYY}.}
But the joke is ultimately on us. Denuto's intuition is substantially correct. When an experienced barrister reformulates it in language recognised by the court, the case succeeds.
...
\section{Software-Agent Infrastructure Can Support Research Provenance}
...
\section{Three Examples of Verifiable Provenance}
...
\section{Vibe Research Can Produce Non-Trivial Results}

The preceding examples establish feasibility, but leave open a second question: can AI-mediated research produce results which the relevant research community regards as genuinely non-trivial? Rather than try to defend the quality of our own work in this respect, we turn to recent examples from higher mathematics.
...
We have considered two possible explanations for the different treatment of vibe coding and vibe research. One is that AI systems cannot assume the relevant forms of responsibility or accountability; another is that their substantive research contributions are too limited to matter. As we have seen, neither explanation is as straightforward as it may first appear.
...
We have considered three possible explanations. First, research collaboration may require forms of responsibility or accountability which AI systems cannot assume. Second, AI contributions may in practice be too limited or trivial for the question to matter. Third, current academic governance structures may simply not provide a place for this form of collaboration. Our argument has been that each explanation is less straightforward than it initially appears.

With regard to the first, we have suggested that ``accountability'' should not be treated as a single unanalysed property. We distinguish institutional accountability from intellectual accountability, and argue that for many of the questions at issue the operationally useful requirement is reliable intellectual provenance: the ability to establish where substantive contributions originated, inspect the evidence supporting them, and obtain informed explanations. The issues which arise here are closely related to those encountered in vibe-coding projects and can be addressed using the same general kind of software infrastructure. Our three examples show that this is not merely a theoretical possibility but can be implemented in practical systems.

With regard to the second, recent developments in mathematics provide strong evidence that frontier AI systems can make substantive contributions to highly non-trivial research results. The cases we have cited differ considerably and should not be treated as equivalent: some involve autonomous solution of a problem, others AI-generated constructions or counterexamples, and still others substantial AI participation in a mixed human--AI process. What they collectively make infeasible to maintain is the assumption that substantive intellectual content in AI-assisted research must, by definition, originate with the human participant.

With regard to the third, we have argued that part of the explanation should be sought in the differing sociologies of software development and academic research. Software teams can often alter their methodology directly when a new tool becomes useful and organisationally acceptable. Academic researchers who wish to publish must operate within governance frameworks which define authorship and acceptable AI assistance. These structures appropriately value stability and consistency, but consequently update more slowly. The ACL Policy on Publication Ethics provides a particularly clear example of a policy whose treatment of generative assistance has remained substantially stable while the technological environment has changed from conversational text generation toward persistent project-scale agents.
...
Finally, we have considered the question of how many researchers are already using versions of vibe research. Large-scale studies establish that LLM involvement in scholarly writing is widespread, but do not tell us how often AI participation extends into the substantive intellectual process which produced the research. Direct evidence is difficult to obtain, particularly when current norms may discourage detailed disclosure. We therefore treat the prevalence of vibe research as an empirical question rather than an established fact, while suspecting that the practices described here will already be familiar to many readers.
