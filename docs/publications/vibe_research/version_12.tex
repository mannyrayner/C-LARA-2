...
The analogy raises an immediate puzzle. If vibe coding and vibe research involve closely related forms of human--AI collaboration, why has vibe coding already become a generally accepted software development practice, while vibe research remains difficult to accommodate within mainstream academia? We suggest three reasonable explanations: that vibe research requires the AI to take responsibility for its work, which it cannot do; that it does not in practice generate any non-trivial results, meaning that the question is uninteresting; and simply that the norms of today's academic community do not permit it. We argue that none of these objections are in fact convincing.

With regard to responsibility, it is indeed true that an AI cannot assume legal responsibility for its work. We argue however that, in practice, the operationally useful concept is not legal responsibility but verifiable provenance, and that the infrastructure used to preserve project history, trace decisions, inspect artefacts, and explain technical choices in vibe coding projects carries over naturally to vibe research projects and can deliver verifiable provenance. We present three examples taken from our own work which show that this is not just a theoretical possibility, but can easily be realised in practice. With regard to non-triviality of AI-generated results, we cite multiple recent example of AI-generated mathematical proofs generally agreed by the mathematical research community to be highly non-trivial. With regard to formal non-acceptance of vibe research practices by the academic community, we argue that an important sociological difference between the software world and the academic world is that academic publishing is governed by formal authorship and ethics policies which change through relatively slow institutional processes, while no comparable mechanisms exist in the software community. We examine the ACL Policy on Publication Ethics as a particularly relevant example. 
...
In the classic Australian film \emph{The Castle},  inexperienced lawyer Dennis Denuto is convinced that his clients have a valid constitutional case, but is unable to express the underlying principle in formal legal terms. His argument eventually collapses into the memorable phrase, ``It's the vibe.'' At first, the audience is invited to laugh: whatever legal reasoning may consist of, Denuto surely does not understand it. But the joke is ultimately on us. Denuto's intuition is substantially correct. When an experienced barrister reformulates it in language recognised by the court, the case succeeds.
...
We largely base our arguments on documented recent examples of vibe research, including our own work. The present paper is itself being produced through this methodology, and its development history forms part of the accompanying provenance record.
...
\section{Real Examples of Tracking Provenance}

We now consider three real examples from our own work, where we show how it is in practice feasible to track provenance. They differ substantially in scale, subject matter, and development time.
...
Development of C-LARA-2 began in November 2025. The project uses a development model in which Codex, under human supervision, performs all the implementation work, including code, tests, infrastructure for running experiments, prompts, technical documentation, roadmaps, publications, and other operational material. Human collaborators determine project goals, identify user needs, evaluate results, impose pedagogical and ethical constraints, and decide whether proposed changes are acceptable \citep[Section~2.4]{bediEtAl2026clara2}.

As of 22 August 2026, the GitHub repository contains more than 105,000 lines of material. Documentation and publication material together account for roughly one third of the total.
...
\section{Non-Triviality of Vibe Research Results: Mathematics}

The examples above concern our own work. It seems reasonable to us to claim that they show it is practically feasible, and even simple, to implement a vibe research infrastructure which verfiably tracks provenance. A determined sceptic might still respond by saying that the results obtained by our vibe research methodology are not particularly interesting, so the question is moot. Rather than try to defend the quality of our work in this respect, we turn instead to recent examples where AIs have been used in higher mathematics
The relevant point in this context is narrower than the claim that AI systems can be fully autonomous mathematicians. It is enough to note that substantive and highly non-trivial mathematical ideas and results can now originate in AI-mediated processes where the decisive intellectual content was not supplied in advance by a human researcher.
...
\section{Institutional Disallowance of Vibe Research}

We have considered two reasonable objections to vibe research, which in practice is closely related to the concept of AI authorship. One is that AIs cannot take responsibility for their work; another is that the work is not in practice interesting enough to be worth discussing. As we have seen, neither objection is as strong as it may first look. A third objection, frequently raised in practice, is even more straightforward. At the moment, most professional academic bodies simply do not allow AI authorship, vibe research, and associated activities. This immediately raises another version of the paper's central question: given that vibe coding and vibe research are similar activities, involving similar risks and rewards, why are software engineers generally allowed to use one, but academic generally not allowed to use the other? We will argue that 
a plausible explanation of the asymmetry we see here concerns the mechanisms through which professional practice changes.
...
The difficulty is not necessarily that the policy makes an incorrect claim. It is that a taxonomy organised around discrete acts of generation becomes increasingly difficult to apply to a persistent agent participating across many stages of a project.
...
We have considered the idea of applying the vibe coding to academic research, and suggested calling it ``vibe research''. We suggest that vibe research can reasonably be considered a more neutral and better-defeined term equivalent to the emotionally loaded phrase ``AI authorship'', We argue that vibe coding and vibe research will in many cases be similar activities, involving similar advantages and similar disadvantages. Despite this, we observe a huge asymmetry. Vibe coding has already become a mainstream software development methodology, but vibe research is hardly accepted at all. Our starting point has been to ask why this is. We have suggested three reasonable explanations: that AIs cannot take responsibility for their work; that they cannot in practice generate interesting research results; and that the practice of vibe research is simply disallowed by the relevant professional bodies concerned. We have argued that none of these three objections stands up well to critical examination.

With regard to the first objection, inability to be responsible for work performed, we have suggested that the notion of ``responsibility'' should be decomposed into ``institutional'' responsibility (essentially, ability to stand for legal consequences) and ``operational responsibility'' (essentially, ability to maintain a record of verified provenance, which can establish where ideas come from and if necessary explain, discuss or retract them). We have argued that operational responsibility is the important component in this context, that the issues which arise are essentially identical to those which arise in vibe coding projects, and that they can be addressed using the same kind of software infrastructure. We have described work in which we have shown that this is not just a theoretical possibility, but can easily be implemented in a practical system.

With regard to the second objection, inability of vibe research teams to generate interesting results, we have cited recent examples from the mathematics community which demonstrate that this argument is clearly no longer valid. On the contrary, teams of this kind have now succeeded in proving many highly non-trivial new theorems. In some cases, it appears that the AI member of the team has achieved this result with next to no input from the human members apart from a suggestion that they examine the problem.

With regard to the third objection, the fact that most professional bodies currently disallow vibe research / AI authors, we have argued that the explanation should be sought in terms of the differing sociologies of the software world and the research world. The research world is intentionally set up so that governance structures do not change rapidly. Although this is in general a good thing, we have argued that the extremely rapid pace of technological change means that it is now creating a serious mismatch between governance and practice; this problem does not exist in the software world, which has quite different governance structures. We have provided a detailed examination of the ACL Code of Ethics as a characteristic example.

Finally, we have considered the question of how many researchers are already using versions of vibe research. Since it is not officially sanctioned, it is hard to obtain clear answers. Despite this, indirect evidence suggests that the practice may already be widespread, and we suspect that the practices we describe here will already be familiar to many readers. 
If that is so, the main novelty of the paper may simply be giving a common practice a name, documenting it explicitly, and asking whether the concepts and governance structures of the research community still describe accurately how some research is actually being done.
