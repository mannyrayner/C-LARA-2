...
Focus:
- Concise first C-LARA-2 progress report by 2026-06-15, tracked by [ISSUE-0008](../issues/issues/ISSUE-0008.json); the former standalone first-progress-report roadmap has been consolidated here.
