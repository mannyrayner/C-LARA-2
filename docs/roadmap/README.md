...
### 18. Backtracking from errors log

Status: **New incident log document added.** See [roadmap/backtracking-from-errors.md](backtracking-from-errors.md).

Focus:
- Keep a short, visible history of rollback/backtracking decisions.
- Record exact corrective git actions and the resulting branch policy.
- Provide a reusable template for future incidents.
