...
- Implemented: translation step (EN→FR) built on the generic annotator with prompts/few-shots and tests.
- Planned/next: MWE detection, lemma/gloss (MWE-aware), pinyin, audio stubs with caching, and HTML compilation hooks.
