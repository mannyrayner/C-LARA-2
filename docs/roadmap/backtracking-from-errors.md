...
This document records major rollback/backtracking decisions, why they were made, and what baseline we reset to. The goal is to keep corrective actions explicit and easy to audit.
...
**Summary**
- `main` had entered an inconsistent post-report state.
- The report-related branch work was intentionally abandoned instead of repaired in place.
...
4. New work starts from current `main` (or fresh branches from it).
