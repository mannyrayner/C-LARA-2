...
- The user-facing examples to foreground are **picture dictionaries** and **more coherent support for low-resource languages**. The first picture-clue word-scramble exercise is a good concrete example of rapid user-requested functionality delivered on top of picture dictionaries and should be considered for the First Progress Report.
...
- Add concrete examples for picture dictionaries, picture-clue word scrambles as rapid user-requested functionality, low-resource-language support, AWS migration, the restricted project-understanding assistant, and first-version AI evaluation of default versus candidate linguistic phase outputs.
