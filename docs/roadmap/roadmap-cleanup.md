...
- **2026-05-29:** Phase 1 started with [reports-and-papers.md](reports-and-papers.md): reorganized it around settled framing, current targets, planned paper split, related-work comparison, workflow rules, and near-term actions; corrected the EuroCALL 2026 deadline to 2026-07-31; synchronized it with the progress-report Markdown workspace; and retired the overlapping `first-progress-report.md` roadmap by merging its execution details into `reports-and-papers.md`.
