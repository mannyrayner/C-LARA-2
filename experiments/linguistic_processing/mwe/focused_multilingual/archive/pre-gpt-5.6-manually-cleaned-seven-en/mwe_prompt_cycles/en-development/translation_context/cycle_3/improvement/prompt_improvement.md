...
- Gold spans: [['high', 'up']]
- Predicted spans: [['high', 'up'], ['on', 'back']]
...
- Predicted spans: [['little', 'fairy-tale', 'boutique'], ['of', 'grander', 'things']]
...
- Predicted spans: [['all', 'over'], ['then', 'on']]
